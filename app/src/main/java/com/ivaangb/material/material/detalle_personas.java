...
public class detalle_personas extends AppCompatActivity {
    private TextView txtCedulaDetalle, txtNombreDetalle, txtApellidoDetalle, txtSexoDetalle;
    private String[] sex;
    ...
    public void eliminar(View v){
        ...
        builder.setMessage(getResources().getString(R.string.pregunto_eliminacion));
    ...
    public void onBackPressed(){
        finish();
        Intent i = new Intent(detalle_personas.this, Principal.class);
        startActivity(i);
    }
